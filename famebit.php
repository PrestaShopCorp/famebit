...
class famebit extends Module
{
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('FameBit');
		$this->description = $this->l('The easiest way to connect with YouTuber influencers to promote your brand.');
